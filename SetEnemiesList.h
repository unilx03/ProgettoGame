...
const int NUM_ENEMIES_DEFAULT = 2; //numero di nemici presenti di default sulla mappa
const int NUM_ENEMIES_GROWTH = 4; //numero di livelli di difficoltà necessari per aumentare il numero di nemici di 1
